...
def FCDenseNet57(n_classes):
    return FCDenseNet(in_channels=4, down_blocks=(4, 4, 4, 4, 4),
...
def FcDnSubtleD(in_channels=3, n_classes=2):
    return FCDenseNet(in_channels=in_channels, down_blocks=(4, 4, 4, 4, 4, 4),
                 up_blocks=(4, 4, 4, 4, 4, 4), bottleneck_layers=4,
                 growth_rate=12, out_chans_first_conv=48, n_classes=n_classes)
