...
def main():
	...
	parser.add_argument('--DATASET_PATH', type=str, default='/home/yangle/TCyb/dataset/tiramisu_corre_large/')
	...
	parser.add_argument('--EXPNAME', type=str, default='EncDec_corre_large')
	...
	model = tiramisu.FcDnSubtle(in_channels=6, n_classes=args.N_CLASSES)
	model = model.cuda()
	...
	# exp_dir = args.EXPERIMENT + args.EXPNAME
	# if os.path.exists(exp_dir):
	# 	shutil.rmtree(exp_dir)

	exp = experiment.Experiment(args.EXPNAME, args.EXPERIMENT)
	exp.init()
